...
public class DownloadFileUrlConnectionImpl implements DownloadFile {
    ...
    @Override
    public void download(final String url, final Map<String, String> extraHeaders, final String destinationPath) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                   ...
                   // urlConnection.setRequestProperty("access-id", extraHeaders.get("access-id"));
                   // urlConnection.setRequestProperty("access-token", extraHeaders.get("access-token"));
