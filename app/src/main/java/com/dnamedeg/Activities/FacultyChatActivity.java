...
import com.dnamedeg.livemodule.ChatListAdapter;
import com.dnamedeg.popup.FullScreenImagePopup;
import com.dnamedeg.popup.UploadFileDialog;
...
public class FacultyChatActivity extends AppCompatActivity implements UploadFileDialog.onUploadFileDialog, FullScreenImagePopup.onFullScreenImagePopup {
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Chat inputMessage = new com.dnamedeg.Models.get_chat_history.Chat();
    ...
    public void onResume() {
       ...
       /* Handler handler = new Handler();
        ...
        handler.postDelayed(r, 5000);*/
      /*  IntentFilter filter = new IntentFilter("com.dnamedeg.Activities.FacultyChatActivity.class");
