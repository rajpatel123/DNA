...
import com.dnamedeg.fragment.HomeFragment;
import com.dnamedeg.fragment.QbankFragment;
import com.dnamedeg.fragment.TestFragment;
import com.dnamedeg.fragment.videoFragment;
import com.dnamedeg.interfaces.FragmentLifecycle;
import com.dnamedeg.popup.EmailVerifyDialog;
...
//            startActivity(intent);
            ...
            i.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.dnamedeg"));
            startActivity(i);
            ...
            if (user != null && !TextUtils.isEmpty(user.getData().getReferral_code())) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,
                        "Hello friends, the best app for medicos is now available at: https://play.google.com/store/apps/details?id=com.dnamedeg");
...
//    }
    ...
    private void showLoginfailedDialog(String message) {
        ...
        // ...Irrelevant code for customizing the buttons and titl
        dialogBuilder.setTitle("Multiple login detected");
        ...
        if (!dialog.isShowing() && !isActivityTransitionRunning())
            dialog.show();
