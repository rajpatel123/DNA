...
import com.dnamedeg.utils.CameraUtils;
        ...
        if (Utils.isInternetConnected(this)) {
            ...
            RestClient.verifyDetail(user_id, v_title,v_image, new Callback<VerifyIdResponse>() {
                ...
                public void onFailure(Call<VerifyIdResponse> call, Throwable t) {
                    Utils.dismissProgressDialog();
                    Toast.makeText(IdVerificationActivitty.this, "Something went wrong!!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Utils.dismissProgressDialog();
            Toast.makeText(IdVerificationActivitty.this, "Internet Connection's Failed", Toast.LENGTH_SHORT).show();
        }
