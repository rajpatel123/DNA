...
import com.dnamedeg.Activities.PaymentDetailActivity;
...
public class LivePaymentDetailActivity extends AppCompatActivity implements PaymentResultListener {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_payment_detail);
...
//
    ...
    private void createOrder() {
        ...
        if (Utils.isInternetConnected(this)) {
            ...
            RestClient.savechatorderdetail(user_id, amount, currency, videoids, product_type, new Callback<CreateOrderResponse>() {
                @Override
                public void onResponse(Call<CreateOrderResponse> call, Response<CreateOrderResponse> response) {
                    ...
                    if (response.body() != null) {
                        ...
                        Log.e("channelData Resp", gson.toJson(createOrderResponse));
    ...
    public void onPaymentSuccess(String paymentID) {
        Log.e("onPaymentSuccess", "" + paymentID);
